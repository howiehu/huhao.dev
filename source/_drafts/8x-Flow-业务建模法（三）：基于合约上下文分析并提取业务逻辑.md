...
一旦合约发生了变更，都需要重新予以确认，以便达成新的业务权责约束。

在理解了合约所蕴含的关键信息之后，需要意识到的是：**在现实中，我们通常不太可能完全基于真实的合同文件进行业务分析和建模。**主要原因是：
...
**了解并学习合约知识，目的是为了我们基于业务的法律属性和权责关系，更好的理解、梳理并设计出更加严谨和合理的业务，或者寻找业务设计上可能存在的权责不匹配所造成的业务或法务漏洞。**
...
为了便于后续的分析和讲解，下面我给出一个虚拟案例，如有类同纯属巧合。

### 案例举例

> 某互联网订餐服务公司“吃了么”寻找供应商协助完成产品开发，通过手机APP（iOS、Android）、微信小程序、Web应用作为用户触点，达成其业务目标。该公司对该产品有如下期望：
> 
> 作为订餐用户：
>
