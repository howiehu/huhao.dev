...
一旦合同发生了变更，都需要重新予以确认，以便达成新的业务权责约束。

在理解了合同所蕴含的关键信息之后，需要意识到的是：**在现实中，我们通常不太可能完全基于真实的合同文件进行业务分析和建模。**主要原因是：

1. 真实的合同受限于编写者的认知水平和专业水平，合同编写的严谨程度会有不同，内容和实际业务可能存在差异，而且出于某些特殊原因，合同的内容可能存在一定的灰度地带。
2. 企业的业务部门和法务部门相互独立，法务部门更多的是为业务部门的业务设计提供法律保障，虽然合同上的条款反映了实际业务，但是合同毕竟不是业务说明书，文本的应用场景不同，所以仅供作为一种关键的业务输入。

**了解并学习合同知识，目的是为了我们基于业务的法律属性和权责关系，更好的理解、梳理并设计出更加严谨和合理的业务，或者寻找业务设计上可能存在的权责不匹配所造成的业务或法务漏洞。**
